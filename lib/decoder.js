...
Decoder.prototype.getVolume = function() {
  return binding.mpg123_get_volume(this.mh);
}

Decoder.prototype.setVolume = function(volume) {
  if(volume > 1) volume = 1;
  else if(volume < 0) volume = 0;
  return binding.mpg123_set_volume(this.mh, volume);
}